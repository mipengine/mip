...
需要注意，页面中必须加载css文件`https://mipcache.bdstatic.com/static/mipmain-v1.0.1.css` 和 js文件`https://mipcache.bdstatic.com/static/mipmain-v1.0.1.js`，`v1.0.1`是版本号，版本号会根据功能的升级而不同，开发中可以根据文档中的说明进行加载。
