...
在页面开发的过程中你需要严格注意[校验规则](http://mip.baidu.com/#../docs/2_guides/check_list_thumbnail.md)。这样才能确保所开发的 MIP 页面是一个有效页面。
...
如果你想让搜索引擎检索到你的 MIP 页面，请参考教程[让搜索发现你的页面](http://mip.baidu.com/#../docs/2_guides/mippagediscover.md)。
