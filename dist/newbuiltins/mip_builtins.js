 ...
 */
define('newbuiltins/mip-img', ['../utils/util', 'customElement'], function(util){
...
;
define('newbuiltins/mip-gif', ['require', 'customElement'], function(require){
...
* @copyright 2015 Baidu.com, Inc. All Rights Reserved
*/
define('newbuiltins/mip-pix', ['require', 'customElement'], function(require){
    var customElem = require('customElement');
...
;
define('newextensions/mip-carousel', ['require', 'customElement', 'gesture'], function(require){
    var customElem = require('customElement');
...
;
define('newextensions/mip-iframe', ['require', 'customElement'], function (require) {
    var customElem = require('customElement');
    var build = function () {
        // 防止多次渲染
        if(this.isRender){
...
define('newbuiltins/mip-appdl', ['require', 'customElement'], function(require) {
    var customElem = require('customElement');
    /**
     * build
     */
    ...
    function renderNoneImg() {
        ...
        var str = "<div class="+postiontye+">"+
            "<div class='mip-appdl-content'>"+
                "<div class='mip-appdl-downloadbbutton'>"+
...
;
define('newbuiltins/img-viewer', ['deps/emit'], function (EventEmitter) {
    var $win = $(window);
    var winInfo = {
        width: $win.width(),
        height: $win.height()
...
;
define('newbuiltins/mip-video', ['utils/util', 'customElement', 'newbuiltins/video/player'], function(util){
    var customElem = require('customElement');
    var player = require('newbuiltins/video/player');
 ...
 */
define('newbuiltins/video/player', ['require'], function(require) {
    ...
    VideoPlayer.prototype = {
        ...
        fullscreenForAndriod: function () {
            ...
            // 引用通用弹窗组件
            require(['newbuiltins/video/popup'], function (Popup) {
                var popup = new Popup({
                    title: options.title || '',
                    content: '',
                    fullView: true,
 ...
 * @author dongshihao
 */
define('newbuiltins/video/popup', ['require'], function (require) {
...
define('newbuiltins/mip_builtins', ['require', 'gesture', 'viewport', 'registerMipElement', 'newbuiltins/mip-gif', 'newbuiltins/mip-img', 'newextensions/mip-carousel', 'newextensions/mip-iframe', 'newbuiltins/mip-video', 'newbuiltins/mip-appdl'], function(require){
    /**
    * 初始化相关JS
    */
    window.MIP = {};
...
require(['newbuiltins/mip_builtins']);
